...
public class Login {
	...
	@BeforeMethod
	  public void setUp() {
		...
		driver.findElement(By.xpath("//*[@id='password']")).sendKeys("lahore123");
	...
	public  static void registrationSelectionFunction(String dataValues[]) throws InterruptedException, IOException {
		...
		System.out.println("*** Into the CustomerRegistration ***"+ customerType);
		...
		if(customerType.equalsIgnoreCase("L0") || customerType.equalsIgnoreCase("L1 Corporate SimSim User") 
		...
		else if(customerType.equalsIgnoreCase("L2-Individual") || customerType.equalsIgnoreCase("L2 Existing Customer")
			...
			cstOnboard.onBoardingL2Group(driver,dataValues[0], 
